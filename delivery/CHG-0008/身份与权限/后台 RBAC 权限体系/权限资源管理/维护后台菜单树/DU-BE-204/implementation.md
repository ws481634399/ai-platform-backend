...
以 Menu 聚合表达菜单规则，应用服务处理父级合法性、循环检测和稳定排序。

主要文件：
- `mall-services/mall-identity/src/main/java/com/ai/mall/identity/domain/model/rbac/Menu.java`
- `mall-services/mall-identity/src/main/java/com/ai/mall/identity/domain/repository/MenuRepository.java`
