...
import com.ai.mall.identity.application.service.AdminAuthenticationApplicationService;
import com.ai.mall.identity.application.service.TokenPairApplicationService;
...
public class AdminAuthController {
    private final AdminAuthenticationApplicationService authentication;
    private final TokenPairApplicationService tokens;

    public AdminAuthController(AdminAuthenticationApplicationService authentication, TokenPairApplicationService tokens) {
    ...
    private ResponseEntity<UnifyResult<TokenResponse>> tokenResponse(TokenPairApplicationService.TokenPair pair,
                                                                      HttpServletResponse response) {
