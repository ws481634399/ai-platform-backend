...
public class AccessTokenService {
    ...
    public AccessTokenService(JwtEncoder encoder, Clock clock, String issuer, String audience, Duration lifetime) {
    ...
    public IssuedAccessToken issue(long adminId, String username, long authVersion) {
